                        ...
                        <article class="post-2573 page type-page status-publish hentry">
                            <div class="entry-content">
                                <div id="pl-2573" class="panel-layout">
                                    ...
                                    <div class="col-lg-6">
                                        <img src="/img/fotoAboutAs.jpg" alt="СтройМастер" style="width: 555px; height: 383px;" >
                                    </div>
                                    <div class="clear"></div>
                                    <hr>
                                    ...
                                    <div id="pg-2573-30" class="panel-grid panel-no-style">
                                        <div id="pgc-2573-30-0" class="panel-grid-cell">
                                            <div id="panel-2573-30-0-0" class="so-panel widget widget_black-studio-tinymce widget_black_studio_tinymce panel-first-child panel-last-child" data-index="71">
                                                <div class="panel-widget-style panel-widget-style-for-2573-30-0-0">
                                                    <div class="textwidget">
                                                        <img id="imgOrder" src="/img/kosmRem.png" style="width: 232px; height: 160px;">
                                            ...
                                            <!--  Модельное окно  -->
                                            <?php require_once $_SERVER['DOCUMENT_ROOT'] . "/template/views/model_window.php" ?>
                                            <!--  Модельное окно  -->
                                        </div>
                                        <div id="pgc-2573-30-0" class="panel-grid-cell">
                                            <div id="panel-2573-30-0-0" class="so-panel widget widget_black-studio-tinymce widget_black_studio_tinymce panel-first-child panel-last-child" data-index="71">
                                                <div class="panel-widget-style panel-widget-style-for-2573-30-0-0">
                                                    <div class="textwidget">
                                                        <img id="imgOrder" src="/img/kapRem.png" style="width: 232px; height: 160px;">
                                        ...
                                        <div id="pgc-2573-30-0" class="panel-grid-cell">
                                            <div id="panel-2573-30-0-0" class="so-panel widget widget_black-studio-tinymce widget_black_studio_tinymce panel-first-child panel-last-child" data-index="71">
                                                <div class="panel-widget-style panel-widget-style-for-2573-30-0-0">
                                                    <div class="textwidget">
                                                        <img id="imgOrder" src="/img/dizProekt.png" style="width: 232px; height: 160px;">
                                        ...
                                        <div id="pgc-2573-30-0" class="panel-grid-cell">
                                            <div id="panel-2573-30-0-0" class="so-panel widget widget_black-studio-tinymce widget_black_studio_tinymce panel-first-child panel-last-child" data-index="71">
                                                <div class="panel-widget-style panel-widget-style-for-2573-30-0-0">
                                                    <div class="textwidget">
                                                        <img id="imgOrder" src="/img/butRem.png" style="width: 232px; height: 160px;">
